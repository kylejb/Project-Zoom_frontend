...
document.addEventListener("DOMContentLoaded", e => {
  ...
  const classroomUrl = "http://localhost:3000/classrooms/1";
  ...
  function fetchTeacher() {
    ...
    .then(data => data.forEach(teacher => {
      ...
      teacherDiv.innerText = `Instructor: ${teacher.name}`;
